                ...
                for (const { name, lat, lon, country, state } of locations) {
                    ...
                    searchItem.innerHTML = `
                        ...
                        <div>
                            ...
                            <p class="label-2 item-subtitle">${name}, ${state || ""}, ${country}</p>
                        </div>
            ...
            for (const [ index, data] of forecastList.entries()){
                ...
                tempLi.innerHTML =`
                                 <div class="card card-sm slider-card">
                                    ...
                                    <img src="./assets/images/weather_icons/${icon}.png" width="48" height="48" loading="lazy"  alt="${description}" class="weather-icon" class="weather-icon" title="${description}">
